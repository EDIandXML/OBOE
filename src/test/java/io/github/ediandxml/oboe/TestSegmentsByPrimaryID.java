...
public class TestSegmentsByPrimaryID {
	...
	public void testUse003() {
		...
		try {
			...
			assertTrue(oe.getMessage().equals("Segment DTP with primaryIDValue of 96638 unknown to container."));
	...
	public void testUse004() {
		...
		try {
			...
			assertTrue(oe.getMessage().equals("Segment HrI with primaryIDValue of BrK unknown to container."));
