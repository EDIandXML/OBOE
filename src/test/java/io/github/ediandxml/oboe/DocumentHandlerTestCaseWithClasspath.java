...
public class DocumentHandlerTestCaseWithClasspath {
	static Logger logr = LogManager.getLogger(DocumentHandlerTestCaseWithClasspath.class);
	...
	public void testX12() throws IOException {
		...
		assertEquals(expected, new String(x.getFormattedText(Format.X12_FORMAT).getBytes()));
	...
	public void testX12ToXMLToX12() throws IOException {
		...
		Envelope x = p1.getEnvelope();
		String actual = new String(x.getFormattedText(Format.VALID_XML_FORMAT).getBytes());

		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.X12.xml"));
	...
	public void testX12LFToXMLToX12LF() throws IOException {
		...
		String t = new String(x.getFormattedText(Format.VALID_XML_FORMAT).getBytes());
	...
	public void testX12ToWellFormedXMLToX12() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.X12.wf.xml"));
		dos.writeBytes(new String(x.getFormattedText(Format.XML_FORMAT).getBytes()));
		dos.close();
	...
	public void testX12JustTA1ToValidXMLToX12JustTA1() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/testJustTA1.X12.xml"));
		dos.writeBytes(t);
		dos.close();
		ValidXMLEDIParser xmp = new ValidXMLEDIParser();
	...
	public void testX12WithTA1ToValidXMLToX12WithTA1() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/testWithTA1.X12.xml"));
		dos.writeBytes(t);
		dos.close();
		ValidXMLEDIParser xmp = new ValidXMLEDIParser();
	...
	public void testX12JustTA1ToWellFormedXMLToX12JustTA1() throws IOException {
		...
		String t = new String(x.getFormattedText(Format.XML_FORMAT).getBytes());

		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/testJustTA1.wfX12.xml"));
		dos.writeBytes(t);
		dos.close();
		EDIXMLParser xmp = new EDIXMLParser();
	...
	public void testX12WithTA1ToWellFormedXMLToX12WithTA1() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/testWithTA1.wfX12.xml"));
		dos.writeBytes(t);
		dos.close();
		EDIXMLParser xmp = new EDIXMLParser();
	...
	public void testX12ValidXMLParser() throws IOException {
		...
		String expected = p1.getEnvelope().getFormattedText(Format.VALID_XML_FORMAT);

		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.X12.ts.xml"));
		...
		assertEquals(expected, new String(xmp.getEnvelope().getFormattedText(Format.VALID_XML_FORMAT).getBytes()));
	...
	public void testX12WellFormedXMLParser() throws IOException {
		...
		Envelope x = p1.getEnvelope();
		String expected = new String(x.getFormattedText(Format.XML_FORMAT).getBytes());

		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.X12.tswf.xml"));
		dos.writeBytes(expected);
		dos.close();
		...
		// i forget why i save the file

		String actual = new String(x.getFormattedText(Format.XML_FORMAT).getBytes());
		dos = new DataOutputStream(new FileOutputStream("testFiles/test.X12.tswfII.xml"));
		dos.writeBytes(actual);
		dos.close();
	...
	public void testX12WellFormedSpacesISAXMLParser() throws IOException {
		...
		String tx = new String(x.getFormattedText(Format.X12_FORMAT).getBytes());
		String ty = new String(y.getFormattedText(Format.X12_FORMAT).getBytes());
	...
	public void testEDIFACT() throws IOException {
		...
		Envelope x = p1.getEnvelope();
		assertEquals(expected, new String(x.getFormattedText(Format.EDIFACT_FORMAT).getBytes()));
	...
	public void testEDIFACTWithBadUNBSegment() throws IOException {
		...
		try {
			...
			assertEquals("UNB", oe.getDocumentErrors().getErrorID(0));
			assertEquals("Invalid token length", oe.getDocumentErrors().getErrorDescription(0));
			return;
		}
		fr.close();
	...
	public void testEDIFACTToXMLToEDIFACT() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.EDIFACT.xml"));
		dos.writeBytes(t);
		dos.close();
		ValidXMLEDIParser xmp = new ValidXMLEDIParser();
	...
	public void testEDIFACTToWellFormedXMLToEDIFACT() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.EDIFACT.wf.xml"));
		dos.writeBytes(t);
		dos.close();
		EDIXMLParser xmp = new EDIXMLParser();
	...
	public void testX12Build() throws OBOEException {
		...
		assertEquals(sb.toString(), new String(b840(null).getFormattedText(Format.X12_FORMAT).getBytes()));
	}
	...
	public void testX12BuildWithDelimiters() throws OBOEException {
		...
		assertEquals(sb.toString(), new String(b840("$|<^%").getFormattedText(Format.X12_FORMAT).getBytes()));
	}
	...
	public void testWellFormedXMLToWellFormedXML() throws IOException {
		 ...
		 * logr.error(fe.getMessage(), fe); fail(fe.getMessage()); } catch(IOException
		 * ie)
		 *
	...
	public Envelope b840(String delimiters) throws OBOEException {
		X12Envelope env = new X12Envelope(EnvelopeFactory.buildEnvelope("x12.envelope", "not set yet"));
	...
	public void buildHeaderST(Table inTable) throws OBOEException {
		...
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 143 Transaction Set
													// Identifier
		// Code
		de.set("840");
		de = (DataElement) segment.buildElement(2); // 329 Transaction Set
													// Control
		// Number
		de.set("00001");
	}
	 ...
	 * To indicate the beginning of a Request for Quotation Transaction Set and
	 * transmit identifying numbers and dates param inTable table containing this
	 * segment throws OBOEException - most likely segment not found
	 */
	public void buildHeaderBQT(Table inTable) throws OBOEException {
		Segment segment = inTable.createSegment("BQT");
		inTable.addSegment(segment);
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 353 Transaction Set
													// Purpose
		// Code
		de.set("363");
		de = (DataElement) segment.buildElement(2); // 586 Request for Quote
		// Reference Number
		de.set("586");
		de = (DataElement) segment.buildElement(3); // 373 Date
		de.set("20010103");
		de = (DataElement) segment.buildElement(4); // 374 Date/Time Qualifier
		de.set("200");
	}
	...
	public void buildDetailPO1(Table inTable) throws OBOEException {
		...
		buildDetailPO1G53(l);
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 350 Assigned
													// Identification
		de.set("PO1350");
		de = (DataElement) segment.buildElement(2); // 330 Quantity Ordered
		de.set("1");
		de = (DataElement) segment.buildElement(3); // 355 Unit or Basis for
		// Measurement Code
		de.set("12");
		de = (DataElement) segment.buildElement(4); // 212 Unit Price
		de.set("1232");
	}
	...
	public void buildDetailPO1LIN(Loop inLoop) throws OBOEException {
		...
		de = (DataElement) segment.buildElement(1); // 350 Assigned
													// Identification
		de.set("LIN350");
		de = (DataElement) segment.buildElement(2); // 235 Product/Service ID
		// Qualifier
		de.set("2");
		de = (DataElement) segment.buildElement(3); // 234 Product/Service ID
		de.set("2-350");
	}
	 ...
	 * To identify the specific type of item maintenance param inSegment segment
	 * containing this subsegment throws OBOEException - most likely segment not
	 * found
	 */
	public void buildDetailPO1G53(Loop inLoop) throws OBOEException {
		...
		inLoop.addSegment(segment);
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 875 Maintenance Type Code
		de.set("875");
	}
	...
	public void buildSummaryCTT(Table inTable) throws OBOEException {
		...
		inTable.addSegment(segment);
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 354 Number of Line Items
		de.set("1");
		de = (DataElement) segment.buildElement(2); // 347 Hash Total
		de.set("1");
	}
	 ...
	 * param inTable table containing this segment throws OBOEException - most
	 * likely segment not found
	 */
	public void buildSummarySE(Table inTable) throws OBOEException {
		Segment segment = inTable.createSegment("SE");
		inTable.addSegment(segment);
		DataElement de;
		de = (DataElement) segment.buildElement(1); // 96 Number of Included
													// Segments
		de.set("1");
		de = (DataElement) segment.buildElement(2); // 329 Transaction Set
													// Control
	...
	public void testTRADACOMS() throws IOException {
		...
		Envelope x = p1.getEnvelope();
		String t = new String(x.getFormattedText(Format.TRADACOMS_FORMAT).getBytes());
		assertEquals(s, t);
	...
	public void testTRADACOMSToXMLToTRADACOMS() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.TRADACOMS.xml"));
		dos.writeBytes(t);
		dos.close();
		ValidXMLEDIParser xmp = new ValidXMLEDIParser();
		...
		t = new String(x.getFormattedText(Format.TRADACOMS_FORMAT).getBytes());
	...
	public void testTRADACOMSToWellFormedXMLToTRADACOMS() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(new FileOutputStream("testFiles/test.TRADACOMS.wf.xml"));
		dos.writeBytes(t);
		dos.close();
		EDIXMLParser xmp = new EDIXMLParser();
