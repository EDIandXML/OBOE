...
public class SearchForMessageFilesBasedOnPropertiesDirective {
	...
	static Logger logr = LogManager.getLogger(SearchForMessageFilesBasedOnPropertiesDirective.class);
	...
	protected void setUp() {
		...
		Util.setOBOEProperty(Util.SEARCH_DIRECTIVE, "TVRS");
	...
	public void testT() throws IOException {
		...
		var idfield = (IDDE) dh.getEnvelope().getFunctionalGroup(0).getTransactionSet(0).getHeaderTable()
				.getSegment("BQT").getElement(1);
	...
	public void testTBuildTS() throws IOException {
		...
		var ts = TransactionSetFactory.buildTransactionSet("840", "T", "1", "2", "3", "p");

		TemplateDataElement idfield = (TemplateDataElement) ts.getHeaderTable().getMyTemplate()
				.getTemplateSegment("BQT").getTemplateElement(1);
		assertEquals("TEST FOUND IN PRODUCTION FOLDER", idfield.getIDList().describe("00"));
	...
	public void testTVBuildTS() throws IOException {
		...
		var ts = TransactionSetFactory.buildTransactionSet("840", "TVR", "004020", "2", "3", "p");
	...
	public void testR() throws IOException {
		...
		try {
			...
			Files.copy(Paths.get("testfiles/receiver.oboe.properties.txt"), Paths.get("OBOE.properties"),
	...
	public void testRBuildTS() throws IOException {
		...
		var ts = TransactionSetFactory.buildTransactionSet("840", "RTV", "1", "receiverII", "3", "p");
		var idfield = (TemplateDataElement) ts.getHeaderTable().getMyTemplate().getTemplateSegment("BQT")
				.getTemplateElement(1);
		assertEquals("TEST RECEIVER II FOLDER", idfield.getIDList().describe("00"));
	...
	public void testVS() throws IOException {
		try {
			Files.copy(Paths.get("testfiles/versionsender.oboe.properties.txt"), Paths.get("OBOE.properties"),
					StandardCopyOption.REPLACE_EXISTING);
	...
	public void testVSBuildTS() throws IOException {
		...
		TransactionSetFactory.clearTable();
		TransactionSetFactory.buildTransactionSet("840", "VS", "004031", "2", "sender", "P");
	...
	public void testXS() throws IOException {
		...
		try {
			Files.copy(Paths.get("testFiles/UseVersionX.oboe.properties.txt"), Paths.get("OBOE.properties"),
					StandardCopyOption.REPLACE_EXISTING);
