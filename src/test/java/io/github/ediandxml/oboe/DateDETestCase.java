...
public class DateDETestCase {
	...
	protected void setUp() {
		...
		de = new DateDE(
				new TemplateDataElement("ID", "Name", 1, "DT", 'R', "Description", 6, 8, "xmltag", null, null, 1, true),
				null);
		de6 = new DateDE(
				new TemplateDataElement("ID", "Name", 1, "DT", 'R', "Description", 6, 6, "xmltag", null, null, 1, true),
				null);
		de8 = new DateDE(
				new TemplateDataElement("ID", "Name", 1, "DT", 'R', "Description", 8, 8, "xmltag", null, null, 1, true),
				null);
	...
	public void test6() {
		...
		SimpleDateFormat sdf6 = new SimpleDateFormat("yyMMdd");
		value6 = sdf6.format(calendar.getTime());
		assertEquals("\tName: " + prettyDate + Util.lineFeed, de6.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>" + value6 + "</xmltag>" + Util.lineFeed, de6.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>" + value6 + "</value></element>" + Util.lineFeed,
	...
	public void testFormattedText() {
		...
		assertEquals("\tName: " + prettyDate + Util.lineFeed, de.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>" + value8 + "</xmltag>" + Util.lineFeed, de.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>" + value8 + "</value></element>" + Util.lineFeed,
	...
	public void testValidate() {
		...
		assertEquals(" invalid character at 6 invalid character at 7", de.validate("123456gh"));
