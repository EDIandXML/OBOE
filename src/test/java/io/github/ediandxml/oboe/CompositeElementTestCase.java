...
public class CompositeElementTestCase {
	...
	protected static void setUp() {
		...
		tcde = new TemplateCompositeElement("compID", "compName", 'M', 1, "description", "comptag", null, 1, true);
	...
	public void testAddingDE() {
		...
		tcde.addElement(new TemplateDataElement("cID", "cName", 1, "AN", 'R', "Char Field", 1, 2, "detag", null, null,
				1, true));
		...
		assertEquals("compID: \tcName: Value" + Util.lineFeed, cde.getFormattedText(Format.UNDEFINED));
		assertEquals(
				"<comptag>" + Util.lineFeed + "<detag>Value</detag>" + Util.lineFeed + "</comptag>" + Util.lineFeed,
				cde.getFormattedText(Format.XML_FORMAT));
		assertEquals("<composite code=\"compID\" name=\"compName\">" + Util.lineFeed
				+ "<element code=\"cID\" name=\"cName\"> <value>Value</value></element>" + Util.lineFeed
				+ "</composite>" + Util.lineFeed, cde.getFormattedText(Format.VALID_XML_FORMAT));
	...
	public void testAdding2DEs() {
		...
		tcde.addElement(new TemplateDataElement("cID", "cName", 2, "AN", 'R', "Char Field", 1, 2, "detag", null, null,
				1, true));
		tcde.addElement(new TemplateDataElement("c2ID", "c2Name", 3, "AN", 'R', "Char 2 Field", 1, 2, "de2tag", null,
				null, 1, true));
		...
		assertEquals("compID: \tcName: Value" + Util.lineFeed + "\tc2Name: 222" + Util.lineFeed,
				cde.getFormattedText(Format.UNDEFINED));
		assertEquals("<comptag>" + Util.lineFeed + "<detag>Value</detag>" + Util.lineFeed + "<de2tag>222</de2tag>"
				+ Util.lineFeed + "</comptag>" + Util.lineFeed, cde.getFormattedText(Format.XML_FORMAT));
		assertEquals("<composite code=\"compID\" name=\"compName\">" + Util.lineFeed
				+ "<element code=\"cID\" name=\"cName\"> <value>Value</value></element>" + Util.lineFeed
				+ "<element code=\"c2ID\" name=\"c2Name\"> <value>222</value></element>" + Util.lineFeed
				+ "</composite>" + Util.lineFeed, cde.getFormattedText(Format.VALID_XML_FORMAT));
	...
	public void testAddingLateDE() {
		...
		tcde.addElement(new TemplateDataElement("c2ID", "c2Name", 5, "AN", 'R', "Char 2 Field", 1, 2, "de2tag", null,
				null, 1, true));
		...
		assertEquals("compID: \tc2Name: 222" + Util.lineFeed, cde.getFormattedText(Format.UNDEFINED));
		assertEquals(
				"<comptag>" + Util.lineFeed + "<de2tag>222</de2tag>" + Util.lineFeed + "</comptag>" + Util.lineFeed,
				cde.getFormattedText(Format.XML_FORMAT));
		assertEquals("<composite code=\"compID\" name=\"compName\">" + Util.lineFeed
				+ "<element code=\"c2ID\" name=\"c2Name\"> <value>222</value></element>" + Util.lineFeed
				+ "</composite>" + Util.lineFeed, cde.getFormattedText(Format.VALID_XML_FORMAT));
	...
	public void testParserNotCatchingTooManyDEsInComposite() {
		try {
			...
			X12DocumentHandler xdh = new X12DocumentHandler(
					new FileReader("testFiles/test278WithTooManyDEsInCompositeField"));
	...
	public void testDefault() {
		TemplateDataElement tde = new TemplateDataElement("cID", "cName", 4, "AN", 'R', "Char Field", 1, 2, "detag",
				null, null, 1, true);
		tcde.addElement(tde);
