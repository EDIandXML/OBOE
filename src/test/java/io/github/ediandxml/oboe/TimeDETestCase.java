...
public class TimeDETestCase {
	...
	protected void setUp() {
		...
		de = new TimeDE(
				new TemplateDataElement("ID", "Name", 1, "TM", 'R', "Description", 4, 4, "xmltag", null, null, 1, true),
				null);
		de6 = new TimeDE(
				new TemplateDataElement("ID", "Name", 1, "TM", 'R', "Description", 4, 6, "xmltag", null, null, 1, true),
				null);
		de8 = new TimeDE(
				new TemplateDataElement("ID", "Name", 1, "TM", 'R', "Description", 4, 8, "xmltag", null, null, 1, true),
				null);
	...
	public void testFormattedText() {
		...
		assertEquals("\tName: " + sdf.format(calendar.getTime()) + Util.lineFeed,
				de.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>" + sdf.format(calendar.getTime()) + "</xmltag>" + Util.lineFeed,
				de.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>" + sdf.format(calendar.getTime())
				+ "</value></element>" + Util.lineFeed, de.getFormattedText(Format.VALID_XML_FORMAT));
	...
	public void testFormattedText6() {
		...
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>" + sdf.format(calendar.getTime())
				+ "</value></element>" + Util.lineFeed, de6.getFormattedText(Format.VALID_XML_FORMAT));
	...
	public void testFormattedText8() {
		...
		assertEquals("\tName: " + sdf.format(calendar.getTime()).substring(0, 8) + Util.lineFeed,
				de8.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>" + sdf.format(calendar.getTime()).substring(0, 8) + "</xmltag>" + Util.lineFeed,
				de8.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>" + sdf.format(calendar.getTime()).substring(0, 8)
				+ "</value></element>" + Util.lineFeed, de8.getFormattedText(Format.VALID_XML_FORMAT));
	 ...
	 * assertEquals(20, de.get(Calendar.HOUR_OF_DAY)); de.set(Calendar.MINUTE, 3);
	 * assertEquals(3, de.get(Calendar.MINUTE)); assertEquals("2003", de.get());
	 *
	 * }
	 */
	@Test
