...
public class DataElementTestCase {
	...
	protected void setUp() {
		...
		de = new CharDE(
				new TemplateDataElement("ID", "Name", 1, "AN", 'M', "Description", 1, 2, "xmltag", null, null, 1, true),
				null);
		de.set("Value");
		deMult = new CharDE(
				new TemplateDataElement("ID", "Name", 1, "AN", 'M', "Description", 1, 2, "xmltag", null, null, 3, true),
				null);
		deMult.set("Value");
	...
	public void testFormattedText() {
		assertEquals("\tName: Value" + Util.lineFeed, de.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>Value</xmltag>" + Util.lineFeed, de.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>Value</value></element>" + Util.lineFeed,
	...
	public void testMultFormattedText() {
		assertEquals("\tName: Value" + Util.lineFeed, deMult.getFormattedText(Format.UNDEFINED));
		assertEquals("<xmltag>Value</xmltag>" + Util.lineFeed, deMult.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"ID\" name=\"Name\"> <value>Value</value></element>" + Util.lineFeed,
