...
public class BinDETestCase {
	...
	protected void setUp() {
		...
		// inUsed)
		de = new BinaryDE(new TemplateDataElement("BIN", "Name", 1, "BIN", 'M', "Binary Desc", 1, 42000, "binaryField",
	...
	public void testFormattedText() {
		...
		assertEquals("<binaryField>Value</binaryField>" + Util.lineFeed, de.getFormattedText(Format.XML_FORMAT));
		assertEquals("<element code=\"BIN\" name=\"Name\"> <value>Value</value></element>" + Util.lineFeed,
