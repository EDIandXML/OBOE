...
public class TrimTest {
	...
	public void testNullPointerInCompDETrim() {
		...
		TemplateSegment ts = new TemplateSegment("t", "t", 10, "n/a", 1, 'M', "inShortName", true, null);
		TemplateCompositeElement tc = new TemplateCompositeElement("tc", "tc", 'M', 10, "n/a", "inShortName", null, 1,
				true);
		ts.addElement(tc);
		TemplateDataElement tde1 = new TemplateDataElement("td1", "td1", 1, "AN", 'M', "n/a", 1, 10, "inShortName",
				null, null, 1, true);
		TemplateDataElement tde2 = new TemplateDataElement("td2", "td2", 2, "AN", 'M', "n/a", 1, 10, "inShortName",
				null, null, 1, true);
		TemplateDataElement tde4 = new TemplateDataElement("td4", "td4", 4, "AN", 'M', "n/a", 1, 10, "inShortName",
				null, null, 1, true);
		TemplateDataElement tde5 = new TemplateDataElement("td5", "td5", 5, "AN", 'M', "n/a", 1, 10, "inShortName",
				null, null, 1, true);
	...
	public void testInLastButNotFirst() {
		...
		TemplateSegment ts = new TemplateSegment("t", "t", 10, "n/a", 1, 'M', "inShortName", true, null);
		TemplateCompositeElement tc1 = new TemplateCompositeElement("tc", "tc", 'M', 1, "n/a", "inShortName", null, 1,
				true);
		TemplateCompositeElement tc2 = new TemplateCompositeElement("tc", "tc", 'M', 2, "n/a", "inShortName", null, 1,
				true);
		TemplateCompositeElement tc3 = new TemplateCompositeElement("tc", "tc", 'M', 3, "n/a", "inShortName", null, 1,
				true);
		ts.addElement(tc1);
		ts.addElement(tc2);
		ts.addElement(tc3);
