...
public class DocumentHandlerTestCaseWithClasspath {
	static Logger logr = LogManager
			.getLogger(DocumentHandlerTestCaseWithClasspath.class);
	...
	protected void setUp() {
		...
		try {
			...
			Files.copy(Paths.get("testFiles/UseClasspath.oboe.properties.txt"),
	...
	public void testEDIFACTWithBadUNBSegment() throws IOException {
		...
		try {
			...
			assertEquals("Invalid token length",
					oe.getDocumentErrors().getErrorDescription(0));
			return;
		}
		fr.close();
