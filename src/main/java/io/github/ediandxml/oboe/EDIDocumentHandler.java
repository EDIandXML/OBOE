 ...
 * 
 * this is an interface to handle high level edi objects. once the handler is
 * registered with the EDIDocumentParser the Parser will call make individual
 * method calls when the objects are created or finished
 *
 */
...
public interface EDIDocumentHandler {
	 ...
	 * only called for segments at the Envelope and functionalGroup level does not
	 * get called for segments within TransactionSet
	 * 
