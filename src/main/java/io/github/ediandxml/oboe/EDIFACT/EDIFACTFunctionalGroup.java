 ...
 *
 */
public class EDIFACTFunctionalGroup extends FunctionalGroup implements IContainedObject {
	...
	public EDIFACTFunctionalGroup(TemplateFunctionalGroup inTFG, IContainedObject inParent) {
	...
	public void setCountInTrailer() throws OBOEException {
		...
		trailer.setDataElementValue("0060", Integer.toString(getTransactionSetCount()));
	}
