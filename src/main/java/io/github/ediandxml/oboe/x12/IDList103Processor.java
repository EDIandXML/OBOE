...
public class IDList103Processor implements IDListProcessor {
	...
	public IDList103Processor() throws IOException {
		...
		IDList currentIDList = new IDList(Util.getMessageDescriptionFolder() + "IDList103Part1.xml",
		...
		currentIDList = new IDList(Util.getMessageDescriptionFolder() + "IDList103Part2.xml", msgDescriptionFolder,
				idListParser);
