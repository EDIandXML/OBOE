...
public class Functional_Acknowledgment {
	...
	/**
	 * Static class method used to generate a 997 TransactionSet. It always returns
	 * a positive acknowledgment and assumes it is reponding to 1 transaction set.
	 *
	 ...
	 * @exception OBOEException - for instance using FA to respond to a FA is not
	 *                          correct.
	 */
