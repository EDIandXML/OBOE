...
/**
 * Defines a contract for containers in OBOE (Open Business Objects for EDI)
 * that manage data elements and composite elements, such as segments or
 * composite elements. Typically implemented by classes representing EDI
 * structures, this interface provides methods for accessing, building, and
 * validating elements within the container.
 *
 * 
 * @since 2025
 * @see Element
...
public interface IElementContainer {
	...
	/**
	 * Retrieves an element by its ID. If multiple elements share the same ID, the
	 * first matching element is returned, making this method less effective for
	 * unique lookups.
	 *
	...
	/**
	 * Retrieves a data element by its name, starting at the specified offset.
	 *
	 ...
	 */
	DataElement getDataElementByName(String name, int offset) throws OBOEException;

	/**
	 * Retrieves an element by its ID and offset, useful when multiple elements
	 * share the same ID.
	 *
	 * @param id     the ID of the element to retrieve
	 * @param offset the starting index (0-based) for the search
	...
	/**
	 * Returns the number of defined elements (data elements and composite elements)
	 * in the container.
	 *
	...
	/**
	 * Checks if the element at the specified 1-based position is a data element.
	 *
	...
	/**
	 * Checks if the element at the specified 1-based position is a composite
	 * element.
	 *
	 * @param position the 1-based position to check
	...
	/**
	 * Builds a data element at the specified 1-based position using the container's
	 * template.
	 *
	...
	/**
	 * Builds a data element with the specified ID using the container's template.
	 *
	...
	/**
	 * Builds a data element with the specified ID and offset using the container's
	 * template.
	 *
	 * @param id     the ID of the element to build
	 * @param offset the starting index (0-based) for the search
	...
	/**
	 * Retrieves the value of a data element by its ID. Returns an empty string if
	 * the element is not built or does not exist.
	 *
	 * @param id the ID of the data element
	 * @return the value of the data element, or an empty string if not set
	 * @throws OBOEException if the ID is unknown or the element is a composite
	 *                       element
	 */
	String getDataElementValue(String id) throws OBOEException;

	/**
	 * Retrieves the value of a data element by its 1-based position. Returns an
	 * empty string if the element is not built or does not exist.
	 *
	...
	/**
	 * Sets the value of a data element by its ID, building the element if it does
	 * not exist.
	 *
	 * @param id    the ID of the data element
	...
	/**
	 * Sets the value of a data element by its ID and offset, building the element
	 ...
	 *                       element
	 */
	Element setDataElementValue(String id, int offset, String value) throws OBOEException;

	/**
	 * Sets the value of a data element by its 1-based position, building the
	 ...
	 *                       composite element
	 */
	Element setDataElementValue(int position, String value) throws OBOEException;

	/**
	 * Validates the container and its elements against their template rules.
	 *
	...
	/**
	 * Validates the container and its elements, collecting errors in the provided
	 * DocumentErrors.
	 *
	...
	/**
	 * Returns the formatted text representation of the container in the specified
	 * format.
	 *
	...
	/**
	 * Returns the total number of elements (data elements and composite elements)
	 * in the container.
	 *
	...
	/**
	 * Removes trailing empty elements from the container, adjusting its size.
	 *
	...
	/**
	 * Finds the index of the first element with the specified XML tag, starting at
	 * the given position.
	 *
	...
	/**
	 * Applies default values to the container's elements based on their template
	 * definitions.
	 */
	void useDefault();

	/**
	 * Retrieves the primary identifying data element for the container, if defined.
	 *
