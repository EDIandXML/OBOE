 ...
 * framework. Used to handle errors during EDI and XML translation, particularly
 * parsing errors.
 * 
 */
public class OBOEException extends RuntimeException {
	 ...
	 *
	 * @param documentErrors The DocumentErrors object containing parsing errors
	 */
	...
	/**
	 * Returns the DocumentErrors object associated with this exception, if any.
	 *
