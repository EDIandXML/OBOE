 ...
 * edi objects are created or finished <br>
 * Unlike the old parser these parsers will not contain the objects, the process
 * of adding objects to owning parents (such as adding functional groups to an
...
public abstract class EDIDocumentParser {
	...
	public abstract boolean parseDocument(java.io.Reader r, boolean b) throws OBOEException;
