...
public class IDListParser extends DefaultHandler implements LexicalHandler {
	 ...
	 * @param inLastDirectoryToLook - name of the top directory where the IDList
	 *                              file could reside
	 * @param vCodes                ArrayList of codes
	 * @param vValues               ArrayList of code descriptive values
	 */
	public void parse(String inXMLFile, String inLastDirectoryToLook, TreeMap<String, String> vCodesValues) {
		xmlFile = inXMLFile;
		xmlInputStream = Util.searchForFileGetInputStream(inXMLFile, inLastDirectoryToLook);
		try {
	...
	public void warning(SAXParseException e) throws SAXException {
		logr.error("Warning at (file " + xmlFile + ", line " + e.getLineNumber() + ", char " + e.getColumnNumber()
				+ "): " + e.getMessage());
	}
	...
	public void error(SAXParseException e) throws SAXException {
		throw new SAXException("Error at (file " + xmlFile + ", line " + e.getLineNumber() + ", char "
	...
	public void fatalError(SAXParseException e) throws SAXException {
		throw new SAXException("Fatal Error at (file " + xmlFile + ", line " + e.getLineNumber() + ", char "
				+ e.getColumnNumber() + "): " + e.getMessage());
	}
