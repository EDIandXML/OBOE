 ...
 * similar to the java.lang.StringTokenizer. It seemed that StringTokenizer
 * couldn't return a zero-length element between 2 tokens - such as token(*) and
 * string in is (***) it would not find 2 zero-length tokens. <br>
 * <p>
...
public class DataTokenizer implements IDataTokenizer {
	 ...
	 *                           characters used
	 */
	public DataTokenizer(String inString, String inTokens, String inEscapeCharacters) {
		int startPos = 0;
