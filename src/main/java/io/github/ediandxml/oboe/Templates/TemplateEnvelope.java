...
public class TemplateEnvelope extends MetaTemplateContainer implements ITemplate {
	...
	public TemplateFunctionalGroup getTemplateFunctionalGroup() {
		for (var conElements : theContainer) {
			if (conElements.getContainerType() == ContainerType.FunctionalGroup) {
	...
	public boolean runValidatingMethod(Envelope inEnv, DocumentErrors inDocErrs) throws OBOEException {
		if (validatingMethod == null) {
			return true;
		}
