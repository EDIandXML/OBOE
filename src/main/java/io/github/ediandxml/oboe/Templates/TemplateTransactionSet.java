...
public class TemplateTransactionSet extends MetaTemplateContainer implements ITemplate, IContainedObject {
	...
	public TemplateTransactionSet(Format inFormat, String inId, String inName, String inRevision,
			String inFunctionalGroup, String inShortDescription, String inShortName, IContainedObject inParent) {
	...
	public void setFormat(Format inFormat) {
		if ((inFormat == Format.XML_FORMAT) || (inFormat == Format.X12_FORMAT) || (inFormat == Format.EDIFACT_FORMAT)
			...
			logr.error("Invalid transaction set format " + inFormat + ".  Value set to -1");
		}
	}
	...
	public boolean runValidatingMethod(TransactionSet inTS, DocumentErrors inDocErrs) throws OBOEException {
		if (validatingMethod == null) {
			return true;
		}
