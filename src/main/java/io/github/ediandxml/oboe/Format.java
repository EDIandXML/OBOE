...
/**
 * Defines supported file and data formats for OBOE (Open Business Objects for
 * EDI). Used in processing and translating EDI and XML data across various
 * standards, such as ANSI X12, UN/EDIFACT, and XML-based formats.
 *
 * @author Joe McVerry
 * @since 2025
 */
public enum Format {
	...
	/**
	 * Represents a custom or proprietary format specific to an OBOE implementation.
	 */
	PREBUILD_FORMAT,
	...
	/**
	 * Represents validated XML format, typically conforming to a specific schema.
	 */
	VALID_XML_FORMAT,

	/**
	 * Represents validated XML format with positional data, such as EDI segment
	 * positions.
	 */
	VALID_XML_FORMAT_WITH_POSITION,

	/**
	 * Represents ANSI X12 EDI format, commonly used in North American industries.
	 */
	X12_FORMAT,
	...
	/**
	 * Represents Automated Clearing House (ACH) format, used for financial EDI
	 * transactions.
	 */
	ACH_FORMAT,
	 ...
	 * @return the corresponding {@code Format}, or {@code UNDEFINED} if the name is
	 *         invalid or null
	 */
	...
	/**
	 * Checks if this format is an EDI standard (X12, EDIFACT, TRADACOMS, or ACH).
	 *
	 * @return true if the format is an EDI standard, false otherwise
	 */
	public boolean isEDIFormat() {
		return this == X12_FORMAT || this == EDIFACT_FORMAT || this == TRADACOMS_FORMAT || this == ACH_FORMAT;
	}
	...
	public boolean isXMLFormat() {
		return this == XML_FORMAT || this == VALID_XML_FORMAT || this == VALID_XML_FORMAT_WITH_POSITION;
	}

	/**
	 * Returns a human-readable name for the format, suitable for logs, UIs, or
	 * error messages.
	 *
